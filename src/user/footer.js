            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-4">
                        ...
                        <p>
                            fd dfsdkok fskdkp;k dl;'dpsp';'k'k f';wddk'
                            fd dfsdkok fskdkp;k dl;'dpsp';'k'k f';wddk'
                            fd dfsdkok fskdkp;k dl;'dpsp';'k'k f';wddk'
                            fd dfsdkok fskdkp;k dl;'dpsp';'k'k f';wddk'
                        </p>
                    ...
                    <div className="col-xl-5">
                        ...
                        <p> #41 2-nd class Otuer Ring Marthalli Forlks Residancy Banglore-560037 </p>
                        <p> e-Mail - Contact@website.com </p>
                        <p> Mobile - +91-356497856 </p>
                    </div>
